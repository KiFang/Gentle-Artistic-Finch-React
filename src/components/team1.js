      ...
      <div className="team1-max-width thq-section-max-width">
        <div className="team1-section-title">
          <span className="thq-body-small team1-text10">
            {props.content1 ?? (
              <Fragment>
                <span className="team1-text65">Join Our Team Today!</span>
              </Fragment>
            )}
          </span>
          <div className="team1-content10">
            <h2 className="thq-heading-2 team1-text11">
              {props.heading1 ?? (
                <Fragment>
                  <span className="team1-text56">Our Amazing Team</span>
                </Fragment>
              )}
            </h2>
                  ...
                  <div className="team1-content13">
                    <div className="team1-title1">
                      <span className="team1-text13 thq-body-small">
                        {props.member1 ?? (
                          <Fragment>
                            <span className="team1-text43">John Doe</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="team1-text14 thq-body-small">
                        {props.member1Job ?? (
                          <Fragment>
                            <span className="team1-text66">CEO</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member1Content ?? (
                        <Fragment>
                          <span className="team1-text64">
                            John is the visionary leader behind our company,
                            guiding us towards success with his innovative ideas
                  ...
                  <div className="team1-content14">
                    <div className="team1-title2">
                      ...
                      <span className="team1-text17 thq-body-small">
                        {props.member2Job ?? (
                          <Fragment>
                            <span className="team1-text61">CTO</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member2Content ?? (
                        <Fragment>
                          <span className="team1-text55">
                            Jane oversees our technological development,
                            ensuring that we stay at the forefront of innovation
                            in all our projects.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="team1-content15">
                    <div className="team1-title3">
                      <span className="team1-text19 thq-body-small">
                        {props.member3 ?? (
                          <Fragment>
                            <span className="team1-text69">Alex Johnson</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member3Content ?? (
                        <Fragment>
                          <span className="team1-text49">
                            Alex is the backbone of our operations, managing
                            resources and processes efficiently to deliver
                            exceptional results.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="team1-content16">
                    <div className="team1-title4">
                      <span className="team1-text22 thq-body-small">
                        {props.member4 ?? (
                          <Fragment>
                            <span className="team1-text41">Sarah Brown</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member4Content ?? (
                        <Fragment>
                          <span className="team1-text57">
                            Sarah leads our marketing efforts with creativity
                            and flair, connecting our projects with the right
                            audience.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="team1-content17">
                    <div className="team1-title5">
                      <span className="team1-text25 thq-body-small">
                        {props.member5 ?? (
                          <Fragment>
                            <span className="team1-text46">Michael Lee</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="team1-text26 thq-body-small">
                        {props.member5Job ?? (
                          <Fragment>
                            <span className="team1-text47">Lead Developer</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member5Content ?? (
                        <Fragment>
                          <span className="team1-text67">
                            Michael is our coding guru, turning ideas into
                            reality with his exceptional programming skills.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="team1-content18">
                    <div className="team1-title6">
                      <span className="team1-text28 thq-body-small">
                        {props.member6 ?? (
                          <Fragment>
                            <span className="team1-text54">Emily Wang</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="team1-text29 thq-body-small">
                        {props.member6Job ?? (
                          <Fragment>
                            <span className="team1-text68">Design Lead</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member6Content ?? (
                        <Fragment>
                          <span className="team1-text63">
                            Emily brings aesthetics and functionality together
                            in our projects, creating visually stunning designs.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="team1-content19">
                    <div className="team1-title7">
                      <span className="team1-text31 thq-body-small">
                        {props.member7 ?? (
                          <Fragment>
                            <span className="team1-text42">David Garcia</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member7Content ?? (
                        <Fragment>
                          <span className="team1-text62">
                            David ensures the financial health of our company,
                            making sure that every project is financially
                            viable.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="team1-content20">
                    <div className="team1-title8">
                      ...
                      <span className="team1-text35 thq-body-small">
                        {props.member8Job ?? (
                          <Fragment>
                            <span className="team1-text48">HR Manager</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member8Content ?? (
                        <Fragment>
                          <span className="team1-text50">
                            Olivia takes care of our most valuable asset - our
                            team, ensuring a positive work environment for
                            everyone.
                          </span>
                        </Fragment>
                      )}
          ...
          <div className="team1-content21">
            <div className="team1-content22">
              <h2 className="thq-heading-2 team1-text37">
                {props.heading2 ?? (
                  <Fragment>
                    <span className="team1-text60">We’re hiring!</span>
                  </Fragment>
                )}
              </h2>
...
Team1.defaultProps = {
  ...
  member7Alt: 'Image of David Garcia, Finance Manager',
  member8Content: undefined,
  member2Src:
    'https://images.unsplash.com/photo-1521715256953-afc5aa00679e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  member1Src:
    'https://images.unsplash.com/photo-1546961329-78bef0414d7c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  member8: undefined,
  member4Job: undefined,
  member3Alt: 'Image of Alex Johnson, Head of Operations',
  member3Src:
    'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNXw&ixlib=rb-4.0.3&q=80&w=1080',
  member5Alt: 'Image of Michael Lee, Lead Developer',
  member2: undefined,
  member6Alt: 'Image of Emily Wang, Design Lead',
  member4Src:
    'https://images.unsplash.com/photo-1628157588553-5eeea00af15c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNXw&ixlib=rb-4.0.3&q=80&w=1080',
  member8Src:
    'https://images.unsplash.com/photo-1614283233556-f35b0c801ef1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNHw&ixlib=rb-4.0.3&q=80&w=1080',
  member8Alt: 'Image of Olivia Martinez, HR Manager',
  member6: undefined,
  member2Alt: 'Image of Jane Smith, CTO',
  member2Content: undefined,
  member5Src:
    'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNXw&ixlib=rb-4.0.3&q=80&w=1080',
  heading1: undefined,
  ...
  member6Src:
    'https://images.unsplash.com/photo-1542295856-082da537cda4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNXw&ixlib=rb-4.0.3&q=80&w=1080',
  content1: undefined,
  ...
  member3: undefined,
  member7Src:
    'https://images.unsplash.com/photo-1503443062224-9f77d743cf25?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczODM1MTYyNXw&ixlib=rb-4.0.3&q=80&w=1080',
}
